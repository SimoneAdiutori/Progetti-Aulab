            ...
            <div class="col-12 col-md-8 d-flex flex-column align-items-center position-relative headerC2">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <h2 class="title-chisiamo"> È una questione di tradizione e storia ed emozioni. È cultura.</h2>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-md-8 testichisiamo">
                {{-- <h2> È una questione di tradizione e storia, esperienze ed emozioni. È cultura.</h2> --}}
                    ...
                    <p>
                        Promuoviamo l’inclusione e l’equità nell’industria gastronomica attraverso contenuti che siano di ispirazione, su problematiche come la parità di genere, per aiutare i ristoranti ad essere posti sempre migliori dove lavorare.
                    </p>
